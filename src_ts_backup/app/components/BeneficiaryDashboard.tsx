...
const beneficiariesDB: Beneficiary[] = [
  {
    id: "BEN2024-789456",
    name: "Rajesh Kumar",
    familyMembers: 4,
...
export function BeneficiaryDashboard() {
  ...
  const handleSearch = () => {
    ...
    setTimeout(() => {
      ...
      const found = beneficiariesDB.find(b => 
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex gap-3">
              <div className="flex-1 relative">
                ...
                <Input
                  placeholder="Search by Name, Beneficiary ID, Ration Card, or Aadhaar Number..."
                  value={searchQuery}
            ...
            <div className="flex flex-wrap gap-2 text-sm text-muted-foreground">
              ...
              <span>•</span>
              <button 
                onClick={() => { setSearchQuery("BEN2024-123456"); }}
                className="text-blue-600 hover:underline"
              >
                BEN2024-123456
              </button>
              <span>•</span>
              <button 
                onClick={() => { setSearchQuery("AAY-GJ-2024-234567"); }}
                className="text-blue-600 hover:underline"
              >
                AAY-GJ-2024-234567
              </button>
      ...
      {!selectedBeneficiary && !searchError && (
      ...
      {selectedBeneficiary && (
        <>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-6">
                {selectedBeneficiary.rationItems.map((item, index) => (
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {selectedBeneficiary.recentTransactions.map((transaction, index) => (
