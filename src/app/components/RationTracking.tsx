      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">Daily Dispensed</p>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4 text-right">
                      ...
                      <div className="text-right min-w-[140px]">
                        ...
                        <p className="text-sm text-gray-600">{percentage.toFixed(1)}% capacity</p>
                      </div>
                    </div>
                  </div>
                  <Progress 
            ...
            {supplierDeliveries.map((delivery, index) => (
              <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 mt-1">{delivery.item} - {delivery.quantity}</p>
                </div>
                <div className="text-right">
                  <p className="text-sm font-medium">Scheduled</p>
                  <p className="text-sm text-gray-600">{delivery.scheduled}</p>
                </div>
              </div>
            ))}
          </div>
