        ...
        <CardContent>
          <div className="space-y-6">
            ...
            return (<div key={index} className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4 text-right">
                      <div className="flex items-center gap-1 text-sm">
                        {item.trend.startsWith('+') ? (<TrendingUp className="w-4 h-4 text-green-600"/>) : (<TrendingDown className="w-4 h-4 text-red-600"/>)}
                  ...
                  <Progress value={percentage} className={`h-3 ${item.status === 'critical' ? '[&>*]:bg-red-500' :
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {supplierDeliveries.map((delivery, index) => (<div key={index} className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
